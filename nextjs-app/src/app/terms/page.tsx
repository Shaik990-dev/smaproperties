...
export default function TermsPage() {
  return (
    <article className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-16">
      ...
      <Section title="2. About SMA Builders & Real Estates">
        <p>
      ...
      <Section title="3. Property listings — important disclaimer">
        <p>
      ...
      <Section title="4. RERA disclosure">
        <p>
      ...
      <Section title="5. Use of the Site">
        <ul>
